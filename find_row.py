...
region1 = (586, 171, 740, 278)
region2 = (586, 452, 740, 278)
...
# 이미지 정렬
aligned_image2_cv = align_images(image1, image2)

if aligned_image2_cv is not None:
    # 정렬된 이미지 저장
    cv2.imwrite('aligned_screenshot2.png', aligned_image2_cv)

    # PIL로 이미지 불러오기
    image1_pil = Image.open('screenshot2.png')
    aligned_image2_pil = Image.open('aligned_screenshot2.png')

    # 차이 계산
    diff = ImageChops.difference(image1_pil, aligned_image2_pil)
